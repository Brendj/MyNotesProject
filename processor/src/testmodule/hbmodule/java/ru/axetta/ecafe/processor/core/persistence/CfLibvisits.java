 ...
 */
public class CfLibvisits {

    private long idoflibvisit;

    public long getIdoflibvisit() {
        return idoflibvisit;
    }

    public void setIdoflibvisit(long idoflibvisit) {
        this.idoflibvisit = idoflibvisit;
    }
    ...
    public boolean equals(Object o) {
        ...
        CfLibvisits that = (CfLibvisits) o;
        ...
        if (idoflibvisit != that.idoflibvisit) {
            return false;
        }
    ...
    @Override
    public int hashCode() {
        int result = (int) (idoflibvisit ^ (idoflibvisit >>> 32));
