 ...
 */
public class CfInternalIncomingDocumentPositions {

    private long idofinternalincomingdocumentpositions;

    public long getIdofinternalincomingdocumentpositions() {
        return idofinternalincomingdocumentpositions;
    }

    public void setIdofinternalincomingdocumentpositions(long idofinternalincomingdocumentpositions) {
        this.idofinternalincomingdocumentpositions = idofinternalincomingdocumentpositions;
    }
    ...
    public boolean equals(Object o) {
        ...
        CfInternalIncomingDocumentPositions that = (CfInternalIncomingDocumentPositions) o;
        ...
        if (idofinternalincomingdocumentpositions != that.idofinternalincomingdocumentpositions) {
            return false;
        }
        if (idoftradematerialgood != that.idoftradematerialgood) {
            return false;
        }
        if (incomingprice != that.incomingprice) {
            return false;
        }
    ...
    @Override
    public int hashCode() {
        int result = (int) (idofinternalincomingdocumentpositions ^ (idofinternalincomingdocumentpositions >>> 32));
        ...
        result = 31 * result + (int) (incomingprice ^ (incomingprice >>> 32));
    ...
    private CfInternalIncomingDocuments cfInternalIncomingDocumentsByIdofinternalincomingdocument;

    public CfInternalIncomingDocuments getCfInternalIncomingDocumentsByIdofinternalincomingdocument() {
        return cfInternalIncomingDocumentsByIdofinternalincomingdocument;
    }

    public void setCfInternalIncomingDocumentsByIdofinternalincomingdocument(
            CfInternalIncomingDocuments cfInternalIncomingDocumentsByIdofinternalincomingdocument) {
        this.cfInternalIncomingDocumentsByIdofinternalincomingdocument = cfInternalIncomingDocumentsByIdofinternalincomingdocument;
    }
}
