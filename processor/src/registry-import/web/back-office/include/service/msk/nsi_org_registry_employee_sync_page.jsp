...
<h:panelGrid id="NSIOrgRegistryEmployeeSynchPage" styleClass="borderless-grid" binding="#{NSIOrgRegistryEmployeeSynchPage.pageComponent}">
    ...
    <h:panelGrid styleClass="borderless-grid" id="synchTableInfoPanel" style="padding-bottom: 5px;">
        <h:outputText escape="true" value="#{NSIOrgRegistryEmployeeSynchPage.errorMessages}" rendered="#{not empty NSIOrgRegistryEmployeeSynchPage.errorMessages}" styleClass="error-messages" style="font-size: 10pt;" />
        <h:outputText escape="true" value="#{NSIOrgRegistryEmployeeSynchPage.infoMessages}" rendered="#{not empty NSIOrgRegistryEmployeeSynchPage.infoMessages}" styleClass="info-messages" style="font-size: 10pt;" />
    </h:panelGrid>

    <rich:simpleTogglePanel label="Параметры" switchType="client" opened="true"
                            headerClass="filter-panel-header">
        <h:panelGrid columns="2" styleClass="borderless-grid" rendered="#{NSIOrgRegistryEmployeeSynchPage.displayOrgSelection}">
            <h:outputText escape="true" value="Организация" styleClass="output-text" />
            <h:panelGroup styleClass="borderless-div">
                <h:inputText value="#{NSIOrgRegistryEmployeeSynchPage.orgName}" readonly="true" styleClass="input-text"
        ...
        <h:panelGrid columns="2" styleClass="borderless-grid">
            ...
            <h:selectOneMenu id="revisionDates" value="#{NSIOrgRegistryEmployeeSynchPage.revisionCreateDate}" style="width:350px;" >
        ...
        <h:panelGrid columns="2" styleClass="borderless-grid">
            ...
            <h:selectOneMenu id="actionFilter" value="#{NSIOrgRegistryEmployeeSynchPage.actionFilter}" style="width:150px;" >
        ...
        <h:panelGrid columns="2" styleClass="borderless-grid">
            ...
            <h:selectBooleanCheckbox value="#{NSIOrgRegistryEmployeeSynchPage.fullNameValidation}" styleClass="output-text"/>
        </h:panelGrid>
        <h:panelGrid columns="2" styleClass="borderless-grid">
            ...
            <h:panelGrid style="text-align: center" columns="2">
                <h:panelGroup id="synchTable">
                    ...
                    <h:panelGrid style="text-align: right" columns="5" columnClasses="selectAll_text,selectAll_button">
                        <h:outputText value="Всего в списке: #{NSIOrgRegistryEmployeeSynchPage.totalCount}" styleClass="output-text" />
                        <rich:spacer width="20px" />
                        <a4j:commandLink value="Отметить все записи к применению" action="#{NSIOrgRegistryEmployeeSynchPage.doMarkAll}"
                                         reRender="workspaceTogglePanel" styleClass="command-button" />
                        <rich:spacer width="20px" />
                        <a4j:commandLink value="Снять все записи c применения" action="#{NSIOrgRegistryEmployeeSynchPage.doUnmarkAll}"
                                         reRender="workspaceTogglePanel" styleClass="command-button" />
                    </h:panelGrid>
                    ...
                    <a4j:commandButton value="Провести полную сверку" action="#{NSIOrgRegistryEmployeeSynchPage.doRefresh}" reRender="synchTable,synchTableInfoPanel,revisionInfo,revisionDates" status="updateStatus"
                                       onclick="this.disabled = true;" oncomplete="this.disabled = false;"/>
                </h:panelGroup>

                <h:panelGrid>
                    <h:panelGrid id="synchTableControl">
                        <a4j:commandButton value="Подтвердить все" action="#{NSIOrgRegistryEmployeeSynchPage.doApply}" reRender="synchTable,synchTableInfoPanel,revisionInfo" status="updateStatus"
                    ...
                    <h:panelGrid id="revisionInfo" columns="2">
                        ...
                        <h:outputText value="#{NSIOrgRegistryEmployeeSynchPage.creationsCount}" styleClass="output-text" style="font-weight: bold;"/>
                        ...
                        <h:outputText value="#{NSIOrgRegistryEmployeeSynchPage.deletionsCount}" styleClass="output-text" style="font-weight: bold;"/>
                        <h:panelGroup styleClass="moveClientRow"><h:outputText value="Количество перемещений" styleClass="output-text"/></h:panelGroup>
                        <h:outputText value="#{NSIOrgRegistryEmployeeSynchPage.movesCount}" styleClass="output-text" style="font-weight: bold;"/>
                        ...
                        <h:outputText value="#{NSIOrgRegistryEmployeeSynchPage.modificationsCount}" styleClass="output-text" style="font-weight: bold;"/>
                        ...
                        <h:outputText value="#{NSIOrgRegistryEmployeeSynchPage.totalCount}" styleClass="output-text" style="font-weight: bold;"/>
                    </h:panelGrid>
                </h:panelGrid>
            </h:panelGrid>
