...
@Component
@Scope("session")
public class SpbRegistrySynchPageBase extends BasicWorkspacePage/* implements CompleteOrgSelectHandler*/{
    ...
    boolean showOnlyClientGroups = true;
    ...
    public boolean isShowOnlyClientGroups() {
        return showOnlyClientGroups;
    }

    public void setShowOnlyClientGroups(boolean showOnlyClientGroups) {
        this.showOnlyClientGroups = showOnlyClientGroups;
    }
    ...
    public void doComment() {
        ...
        FrontController controller = SpbRegistrySynchPageBase.createController(logger);
        String author = "";
        try {
    ...
    public void doChangeDisplayMode(ActionEvent event) {
        idOfSelectedError = -1L;
        errorComment = "";
    }
