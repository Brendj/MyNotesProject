...
public class ReportJobConstants {
    ...
    public static final ReportHint[] REPORT_HINTS = {
            ...
            new ReportHint(ClientMenuDetailsGroupByMenuOriginReport.class.getCanonicalName(), new int[]{}),
            new ReportHint(ContragentPaymentReport.class.getCanonicalName(), new int[]{21})
    };
