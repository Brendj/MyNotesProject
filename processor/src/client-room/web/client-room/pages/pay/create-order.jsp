...
<%   try{
   ...
   // RuntimeContext runtimeContext = null;
    ...
    RBKMoneyConfigExt rbkMoneyConfig=rbkConfigResult.getRbkConfig();
    ChronopayConfigExt chronopayConfig=chronopayConfigResult.getChronopayConfig();


    chronopaySection=chronopayConfig.isShow();
     logger.info("chronopayIsShow: "+chronopayConfig.isShow());
           //
    rbkSection= rbkMoneyConfig.isShow() ;
    logger.info("rbkIsShow: "+rbkMoneyConfig.isShow());
...
<%
    ...
    if (StringUtils.equals(contragentName, rbkMoneyConfig.getContragentName())) {
     ...
     /*   try {
        ...
        URI confirmUri = new URI(rbkMoneyConfig.getPurchaseUri());
        URI cancelUri;
        URI successUri;
        URI failUri;
        try {
