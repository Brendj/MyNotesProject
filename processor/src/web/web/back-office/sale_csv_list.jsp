...
%><f:view>
    <h:outputText escape="false" value="Организация;Название;Цена за ед;Скидка на ед;Кол-во;Сумма без скидки;Сумма скидки;Кол-во со скидкой;Итоговая сумма;Время первой продажи;Время последней продажи" />
    ...
    <a4j:repeat value="#{mainPage.salesReportPage.salesReport.salesItems}" var="item">
        <h:outputText escape="false" value="#{item.officialName};#{item.menuDetailName};#{item.rPrice};#{item.discount};#{item.qty};#{item.sumPrice};#{item.discountForReport};#{item.qtyDiscount};#{item.total}" />
