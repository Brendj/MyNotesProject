...
<h:panelGrid id="actOfInventarizationListPage" binding="#{actOfInventarizationListPage.pageComponent}"
    ...
    <rich:simpleTogglePanel label="Фильтр (#{actOfInventarizationListPage.filter.status})" switchType="client" opened="true"
        ...
        <h:panelGrid columns="2" styleClass="borderless-grid">
            ...
            <h:panelGroup styleClass="borderless-div">
                <h:inputText value="#{actOfInventarizationListPage.shortName}" readonly="true" styleClass="input-text"
    ...
    <rich:dataTable value="#{actOfInventarizationListPage.itemList}" var="act" rowKeyVar="row">
...
<a4j:status id="sActOfInventarizationListGenerateStatus">
    <f:facet name="start">
