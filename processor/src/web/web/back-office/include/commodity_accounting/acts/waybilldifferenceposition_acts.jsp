...
<h:panelGrid id="ctOfWayBillDifferencePositionListPage" binding="#{actOfWayBillDifferencePositionListPage.pageComponent}"
             styleClass="borderless-grid">

    <rich:simpleTogglePanel label="Фильтр (#{actOfWayBillDifferencePositionListPage.filter.status})" switchType="client" opened="true"
                            headerClass="filter-panel-header">

        <h:panelGrid columns="2" styleClass="borderless-grid">
            <h:outputText escape="true" value="Организация" styleClass="output-text" />
            <h:panelGroup styleClass="borderless-div">
                <h:inputText value="#{actOfWayBillDifferencePositionListPage.shortName}" readonly="true" styleClass="input-text"
    ...
    <rich:dataTable value="#{actOfWayBillDifferencePositionListPage.itemList}" var="act" rowKeyVar="row">
        ...
        <rich:column headerClass="column-header" sortBy="#{act.totalCount}">
            ...
            <h:outputText escape="true" value="#{act.totalCount}" styleClass="output-text"/>
        </rich:column>
