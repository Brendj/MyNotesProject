...
<h:panelGrid id="contragentPreordersReportPanelGrid" binding="#{mainPage.contragentPreordersReportPage.pageComponent}"
    ...
    <h:panelGrid styleClass="borderless-grid" columns="2">
        ...
        <h:outputText styleClass="output-text" escape="true" value="Скрывать ОО с пустыми данными" />
    ...
    <h:panelGrid columns="2">
        <a4j:commandButton value="Генерировать отчет" action="#{mainPage.contragentPreordersReportPage.buildReport}"
