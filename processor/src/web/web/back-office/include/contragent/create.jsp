...
<h:panelGrid id="contragentCreateGrid" binding="#{mainPage.contragentCreatePage.pageComponent}"
    ...
    <h:outputText escape="true" rendered="false" value="Список рассылки сводного отчета по заявкам" styleClass="output-text" />
    <h:inputText rendered="false" value="#{mainPage.contragentCreatePage.requestNotifyMailList}" maxlength="128" styleClass="input-text" />
</h:panelGrid>
