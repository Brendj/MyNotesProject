...
<h:panelGrid id="categoryDSZNCreatePanel" binding="#{categoryDiscountDSZNCreatePage.pageComponent}"
...
<h:panelGrid styleClass="borderless-grid">
    <a4j:commandButton value="Зарегистрировать категорию" action="#{categoryDiscountDSZNCreatePage.onSave}"
                       reRender="categoryDSZNCreatePanel" styleClass="command-button" />
</h:panelGrid>
<h:panelGrid styleClass="borderless-grid">
