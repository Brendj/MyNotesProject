...
<%--@elvariable id="productGroupItemsPanel" type="ru.axetta.ecafe.processor.web.ui.option.configurationProvider.product.group.ProductGroupItemsPanel"--%>
<rich:modalPanel id="productGroupSelectModalPanel" autosized="true" width="200" headerClass="modal-panel-header">
    ...
    <a4j:form id="productGroupModalForm" styleClass="borderless-form"
              eventsQueue="productGroupSelectorFormEventsQueue">
            ...
            <tr>
                <td style="text-align: left;">
                    ...
                    <h:panelGrid columns="4" styleClass="borderless-grid">
                        ...
                        <h:inputText value="#{productGroupItemsPanel.filter}" size="48" maxlength="128"
                                     styleClass="input-text" />
                        <a4j:commandLink action="#{productGroupItemsPanel.updateConfigurationProviderSelectPage}" reRender="productGroupModalForm"
                        ...
                        <a4j:commandLink action="#{productGroupItemsPanel.updateConfigurationProviderSelectPage}" reRender="productGroupModalForm"
                            ...
                            <f:setPropertyActionListener value="" target="#{productGroupItemsPanel.filter}" />
                        </a4j:commandLink>
                    </h:panelGrid>
                </td>
            </tr>
            <tr>
                <td style="text-align: center;">
                    <rich:dataTable value="#{productGroupItemsPanel.productGroupList}" var="productGroup" rowKeyVar="row"
                        ...
                        <a4j:support event="onRowClick" reRender="productGroupModalForm">
                            <f:setPropertyActionListener value="#{productGroup}"
                                                         target="#{productGroupItemsPanel.selectProductGroup}" />
                        </a4j:support>
                        ...
                        <rich:column headerClass="column-header">
                            ...
                            <h:outputText value="#{productGroup.nameOfGroup}"/>
                        </rich:column>
                        <f:facet name="footer">
            ...
            <tr>
                <td style="text-align: right;">
                    <h:panelGrid styleClass="borderless-div" columns="2">
                        <a4j:commandButton value="Ok" action="#{productGroupItemsPanel.addProductGroup}"
