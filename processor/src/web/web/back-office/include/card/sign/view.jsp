...
<h:panelGrid id="cardSignViewGrid" binding="#{cardSignViewPage.pageComponent}" styleClass="borderless-grid"
             columns="2">
    ...
    <h:inputText value="#{cardSignViewPage.signType}" styleClass="input-text" readonly="true"/>
...
<h:panelGrid styleClass="borderless-grid">
    <a4j:commandButton value="Редактировать" action="#{cardSignEditPage.show}"
