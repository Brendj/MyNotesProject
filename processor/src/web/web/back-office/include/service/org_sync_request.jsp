...
<h:panelGrid id="orgSyncRequestPage" binding="#{orgSyncRequestPage.pageComponent}" styleClass="borderless-grid"
    ...
    <rich:panel>
        ...
        <h:panelGrid columns="2" styleClass="borderless-grid">
            ...
            <h:selectOneMenu id="orgDistricts" value="#{orgSyncRequestPage.selectedDistricts}" styleClass="input-text"
                             style="width: 250px;">
                <f:selectItems value="#{orgSyncRequestPage.listOfOrgDistricts}" />
            </h:selectOneMenu>
