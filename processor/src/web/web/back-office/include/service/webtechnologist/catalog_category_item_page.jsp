...
<h:panelGrid id="webTechnologistcategoryItemCatalogItemListPagePanelGrid"
    ...
    <!-- ********* CREATE MODAL PANEL ********* -->
    <rich:modalPanel id="webtechnologistcategoryItemItemCreatePanel" minWidth="150" minHeight="70" resizeable="false"
                     domElementAttachment="form">
        <f:facet name="header">
            <h:panelGroup>
                <h:outputText value="Создание Категории"/>
            </h:panelGroup>
        </f:facet>
        <f:facet name="controls">
            <h:panelGroup>
                <rich:componentControl for="webtechnologistcategoryItemItemCreatePanel" attachTo="hidelink"
        ...
        <h:panelGrid columns="2" styleClass="borderless-grid">
            ...
            <a4j:commandButton oncomplete="Richfaces.hideModalPanel('webtechnologistcategoryItemItemCreatePanel')"
                               value="Закрыть"
                               status="WebTechnologcategoryItemCatalogItemProcessStatus"
                               action="#{categoryCatalogListPage.clearDescriptionForNewCatalog()}"
                               reRender="webtechnologistcategoryItemItemCreatePanel"/>
            <a4j:commandButton oncomplete="Richfaces.hideModalPanel('webtechnologistcategoryItemItemCreatePanel')"
                               reRender="webtechnologistcategoryItemCatalogItemListTable, webtechnologistcategoryItemItemCreatePanel"
    ...
    <rich:modalPanel id="webtechnologistcategoryItemCreateItemPanel" minWidth="150" minHeight="70" resizeable="false"
                     domElementAttachment="form">
        <f:facet name="header">
            <h:panelGroup>
        ...
        <f:facet name="controls">
            <h:panelGroup>
                <rich:componentControl for="webtechnologistcategoryItemCreateItemPanel" attachTo="hidelink"
                                       operation="hide" event="onclick"/>
            </h:panelGroup>
        </f:facet>
        <h:panelGrid columns="2" styleClass="borderless-grid">
            ...
            <a4j:commandButton oncomplete="Richfaces.hideModalPanel('webtechnologistcategoryItemCreateItemPanel')"
                               value="Создать"
                               reRender="webtechnologistcategoryItemCatalogItemListTable, webtechnologistcategoryItemCreateItemPanel"
                               action="#{categoryCatalogListPage.createNewItem()}"
                               status="WebTechnologcategoryItemCatalogItemProcessStatus"/>
            <a4j:commandButton oncomplete="Richfaces.hideModalPanel('webtechnologistcategoryItemCreateItemPanel')"
                               value="Закрыть"
    ...
    <rich:modalPanel id="webtechnologistcategoryItemViewCategoryPanel" resizeable="false" minWidth="700"
                     minHeight="700"
                     domElementAttachment="form">
    <f:facet name="header">
        <h:panelGroup>
            <h:outputText value="Просмотр Элементов"/>
        </h:panelGroup>
    </f:facet>
    <f:facet name="controls">
        <h:panelGroup>
    ...
    <h:panelGrid columns="2" styleClass="borderless-grid">
        <rich:dataTable id="WtCatalogItemListTable"
                        value="#{categoryCatalogListPage.getItemsForSelectedItem()}" var="item" rows="10"
    ...
    <h:panelGrid columns="2">
        ...
        <a4j:commandButton value="Создать"
                           reRender="webtechnologistcategoryItemCatalogItemListTable, webtechnologistcategoryItemViewCategoryPanel"
                           action="#{categoryCatalogListPage.createNewItem()}"
                           status="webtechnologistcategoryItemViewCategoryPanel"/>
    </h:panelGrid>
</h:panelGrid>
<h:panelGrid columns="2">
    <a4j:commandButton oncomplete="Richfaces.hideModalPanel('webtechnologistcategoryItemViewCategoryPanel')"
                       ...
                       status="WebTechnologcategoryItemCatalogItemProcessStatus"
                       action="#{categoryCatalogListPage.clearDescriptionForNewCatalog()}"
                       reRender="webtechnologistcategoryItemViewCategoryPanel"/>
</h:panelGrid>
</rich:modalPanel>
<!-- Main page -->
