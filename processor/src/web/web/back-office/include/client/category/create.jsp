...
<h:panelGrid id="categoryCreatePanel" binding="#{mainPage.categoryCreatePage.pageComponent}"
    ...
    <rich:calendar value="#{mainPage.categoryCreatePage.lastUpdate}" datePattern="dd.MM.yyyy" converter="dateConverter"
                   inputClass="input-text" showWeeksBar="false" />
</h:panelGrid>
<h:panelGrid styleClass="borderless-grid">
    <a4j:commandButton value="Зарегистрировать категорию" action="#{mainPage.createCategory}"
