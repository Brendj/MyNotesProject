    ...
    <f:facet name="footer">
        ...
        <f:facet name="header">
            <rich:columnGroup>
                ...
                <rich:column headerClass="center-aligned-column">
                    <h:outputText value="4" styleClass="output-text" escape="true"/>
                </rich:column>
                <rich:column headerClass="center-aligned-column">
                    <h:outputText value="5" styleClass="output-text" escape="true"/>
                </rich:column>
                <rich:column headerClass="center-aligned-column">
                    <h:outputText value="6" styleClass="output-text" escape="true"/>
                </rich:column>
                <rich:column headerClass="center-aligned-column">
                    <h:outputText value="7" styleClass="output-text" escape="true"/>
                </rich:column>
                <rich:column headerClass="center-aligned-column">
                    <h:outputText value="8" styleClass="output-text" escape="true"/>
                </rich:column>
                <rich:column headerClass="center-aligned-column">
                    <h:outputText value="9" styleClass="output-text" escape="true"/>
                </rich:column>
            </rich:columnGroup>
        </f:facet>
        <rich:column >
