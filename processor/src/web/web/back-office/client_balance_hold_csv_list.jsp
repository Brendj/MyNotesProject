...
%><f:view>
    <h:outputText escape="false" value="Дата и время заявления;Номер л/с обучающегося;Группа;ФИО обучающегося;Номер л/с заявителя;Телефон заявителя;ФИО заявителя;Размер баланса;Сумма возврата;Статус заявления"/>
    ...
    <a4j:repeat value="#{clientBalanceHoldPage.items}" var="item">
        ...
        <h:outputText escape="false" value="#{item.contractId};#{item.group};#{item.fio};#{item.declarerContractId};#{item.declarerPhone};#{item.declarerFio};" />
