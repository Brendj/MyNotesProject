...
public class OrgListLoaderPage extends BasicWorkspacePage {
    ...
    protected static final String [][] COLUMN_NAMES = new String [][] {
            { "idOfOrg",                "Идентификатор организации" },
            { "version",                 "Версия" },
            { "shortName",              "Наименование" },
            { "officialName",           "Официальное наименование" },
            { "address",                "Адрес" },
            { "idOfOfficialPerson",     "Идентификатор физического лица по договору" },
            { "officialPosition",       "Должность физического лица по договору" },
            { "contractId",             "Номер договора" },
            { "contractDate",           "Дата заключения договора" },
            { "state",                  "Статус (0 - Не обслуживается, 1 - Обслуживается)" },
            { "cardLimit",              "Лимит овердрафта по умолчанию" },
            { "publicKey",              "Открытый ключ" },
            { "lastClientContractId",   "Л/с, присвоенный последнему клиенту" },
            { "priceOfSms",             "Стоимость SMS" },
            { "subscriptionPrice",      "Цена подписки на SMS" },
            { "defaultSupplier",        "Поставщик ТСП по умолчанию" },
            { "guid",                   "GUID" },
            { "tag",                    "Тэг" },
            { "city",                   "Город" },
            { "district",               "Район" },
            ...
            { "additionalIdBuilding",   "Уникальный номер здания" },
