...
@Component
@Scope(value = "session")
public class JournalAuthenticationReportPage extends OnlineReportPage implements UserSelectPage.CompleteHandler {

    private final static Logger logger = LoggerFactory.getLogger(JournalAuthenticationReportPage.class);
    ...
    private BasicReportJob getReport() {
        ...
        JournalAuthenticationReport.Builder builder = new JournalAuthenticationReport.Builder(templateFilename, getUser());
    ...
    private String checkIsExistFile(String suffix) {
        ...
        String templateShortFileName = JournalAuthenticationReport.class.getSimpleName() + suffix;
    ...
    private String buildFileName(Date generateTime, BasicReportJob basicReportJob) {
        ...
        return String.format("%s-%s-%s", "JournalAuthenticationReport", reportDistinctText, format);
    }
    ...
    private Long getUser() {
        return userItem.getIdOfUser();
    }

    public List<UserSelectPage.UserShortItem> getUserItems() {
        return new ArrayList<UserSelectPage.UserShortItem>();
    }
