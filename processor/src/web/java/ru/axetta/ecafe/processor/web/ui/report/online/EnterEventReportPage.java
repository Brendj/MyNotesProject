...
public class EnterEventReportPage extends OnlineReportPage {
    private final static Logger logger = LoggerFactory.getLogger(EnterEventReportPage.class);
    ...
    public Object buildReportHTML() {
        ...
        EnterEventReport.Builder builder = new EnterEventReport.Builder(templateFilename);
        if (idOfOrg == null) {
    ...
    private String checkIsExistFile() {
        ...
        String templateShortFilename = EnterEventReport.class.getSimpleName() + ".jasper";
            ...
            if (idOfOrg == null) {
                ...
                try {
                    if (report != null) {
                        ...
                        response.setHeader("Content-disposition", "inline;filename=enterEventReport.xls");
