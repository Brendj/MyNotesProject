...
public class DetailedDeviationsWithoutCorpsReportPage extends OnlineReportPage {
    ...
    private DetailedDeviationsWithoutCorpsJasperReport buildReport() {
        ...
        return (DetailedDeviationsWithoutCorpsJasperReport) report;
    }
    ...
    public void generateXLS(ActionEvent event) {
        ...
        try {
            ...
            if (report != null) {
                ...
                response.setHeader("Content-disposition", "inline;filename=detailedDeviationsWithoutCorpsReport.xls");
    ...
    public String getPageFilename() {
        return "report/online/deviation_without_corps_report";
    }
