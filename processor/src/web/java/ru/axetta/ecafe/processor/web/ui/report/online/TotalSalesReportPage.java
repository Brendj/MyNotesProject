...
@Component
@Scope("session")
//todo TotalSalesReport rename TotalSalesReport
public class TotalSalesReportPage extends OnlineReportPage{

    private final static Logger logger = LoggerFactory.getLogger(TotalSalesReportPage.class);
