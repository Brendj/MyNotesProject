...
@Component
@Scope("session")
public class PhotoRegistryPage extends BasicWorkspacePage implements OrgSelectPage.CompleteHandler {
    private static final Logger logger = LoggerFactory.getLogger(PhotoRegistryPage.class);
