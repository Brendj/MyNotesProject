...
import ru.axetta.ecafe.processor.core.report.TotalBenefFeedReport;
...
@Component
@Scope("session")
public class TotalBenefFeedReportPage extends OnlineReportPage{

    private final static Logger logger = LoggerFactory.getLogger(TotalBenefFeedReportPage.class);
    ...
    public Object buildReportHTML() {
        ...
        String templateShortFileName = TotalBenefFeedReport.class.getSimpleName() + ".jasper";
        String templateFilename = autoReportGenerator.getReportsTemplateFilePath() + templateShortFileName;
        if(!(new File(templateFilename)).exists()){
            printError(String.format("Не найден файл шаблона '%s'", templateShortFileName));
            return null;
        }
        TotalBenefFeedReport.Builder builder = new TotalBenefFeedReport.Builder(templateFilename);
    ...
    public void showCSVList(ActionEvent actionEvent){
        ...
        try {
            ...
            String filename = buildFileName(generateTime, totalBenefFeedReport);
            response.setHeader("Content-disposition", String.format("inline;filename=%s", filename));

            JRXlsExporter xlsExport = new JRXlsExporter();
            xlsExport.setParameter(JRCsvExporterParameter.JASPER_PRINT, totalBenefFeedReport.getPrint());
    ...
    private String buildFileName(Date generateTime, TotalBenefFeedReport totalBenefFeedReport) {
        DateFormat timeFormat = new SimpleDateFormat("dd.MM.yyyy-HH:mm:ss");
        String reportDistinctText = totalBenefFeedReport.getReportDistinctText();
        String format = timeFormat.format(generateTime);
        return String.format("%s-%s-%s.xls", "TotalBenefFeedReport", reportDistinctText, format);
    }
    ...
    public String getPageFilename() {
        return "report/online/total_benef_feed_report";
    }
