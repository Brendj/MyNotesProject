...
import ru.axetta.ecafe.processor.core.report.CardApplicationReport;
...
import ru.axetta.ecafe.processor.web.ui.report.online.PreordersReportPage;
...
@Component
@Scope(value = "session")
public class CardApplicationReportPage extends OnlineReportPage {
    private static final Logger logger = LoggerFactory.getLogger(PreordersReportPage.class);
    private final String reportName = "Отчет по заявлениям на карту";
    ...
    public Object buildReportHTML() {
        ...
        CardApplicationReport.Builder builder = new CardApplicationReport.Builder(templateFilename);
    ...
    private Properties buildProperties() {
        ...
        properties.setProperty(CardApplicationReport.P_ID_OF_CLIENTS, idOfClients);
        properties.setProperty(CardApplicationReport.P_ENABLE_DATE_FILTER, enableDateFilter.toString());
        return properties;
    }

    private String checkIsExistFile(String suffix) {
        AutoReportGenerator autoReportGenerator = RuntimeContext.getInstance().getAutoReportGenerator();
        String templateShortFileName = CardApplicationReport.class.getSimpleName() + suffix;
    ...
    public Boolean getEnableDateFilter() {
        return enableDateFilter;
    }

    public void setEnableDateFilter(Boolean enableDateFilter) {
