 ...
 *       &lt;sequence>
 *         &lt;element name="Client" type="{http://soap.integra.partner.web.processor.ecafe.axetta.ru/}ClientItem" maxOccurs="unbounded" minOccurs="0"/>
 *       &lt;/sequence>
 *     &lt;/restriction>
 *   &lt;/complexContent>
 * &lt;/complexType>
...
public class ClientList {
    ...
    protected List<ClientItem> client;
    ...
    public List<ClientItem> getClient() {
        if (client == null) {
            client = new ArrayList<ClientItem>();
        }
        return this.client;
    }
