 ...
 * generated in the ru.msk.schemas.uec.identification.v1 package. 
...
public class ObjectFactory {
    ...
    private final static QName _AuthorityPersonTypeMiddleName_QNAME = new QName("http://schemas.msk.ru/uec/identification/v1", "middleName");
    ...
    /**
     * Create a new ObjectFactory that can be used to create new instances of schema derived classes for package: ru.msk.schemas.uec.identification.v1
     * 
     */
    ...
    public JAXBElement<String> createAuthorityPersonTypeMiddleName(String value) {
        return new JAXBElement<String>(_AuthorityPersonTypeMiddleName_QNAME, String.class, AuthorityPersonType.class, value);
    }
    ...
    public JAXBElement<String> createNameTypeMiddleName(String value) {
        return new JAXBElement<String>(_AuthorityPersonTypeMiddleName_QNAME, String.class, NameType.class, value);
    }
