    ...
    extends Service
{
    ...
    static {
        ...
        try {
            ...
            url = new URL(baseUrl, "http://193.47.154.34:7002/uec-service-war/TransactionService?wsdl");
        } catch (MalformedURLException e) {
            logger.warning("Failed to create URL for the wsdl Location: 'http://193.47.154.34:7002/uec-service-war/TransactionService?wsdl', retrying as a local file");
