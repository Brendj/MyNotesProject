    ...
    public static List<LatePaymentReportModel> getCountOfBeneficiariesByOrg(Session session, List<Long> idOfOrgList,
        ...
        Query query = session.createSQLQuery(
                "WITH a AS ("
                        ...
                        + "ORDER BY o.idoforg "
                        + "), "
                        + "b AS (SELECT cfo.shortnameinfoservice as orgname, cfo.address, "
                        ...
                        + "AND (cl.idofclientgroup < 1100000000 or cl.idofclientgroup is null) GROUP BY cfo.idoforg, cfo.shortnameinfoservice, cfo.address "
