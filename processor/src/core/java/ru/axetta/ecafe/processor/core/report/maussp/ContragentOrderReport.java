...
public class ContragentOrderReport extends BasicJasperReport {
    ...
    */
    public static final String REPORT_NAME = "Отчет по клиентам за месяц";
    public static final String[] TEMPLATE_FILE_NAMES = {"ContragentOrderReport.jasper"};
        ...
        public void run() {
            ...
            try {
                ...
                for (Object object : allOrgs) {
                    ...
                    ReportPropertiesUtils.addProperties(properties, ContragentOrderReport.class, null);
