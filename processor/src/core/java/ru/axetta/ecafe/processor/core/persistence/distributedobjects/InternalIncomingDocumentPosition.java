...
public class InternalIncomingDocumentPosition extends DistributedObject {
    ...
    @Override
    protected InternalIncomingDocumentPosition parseAttributes(Node node) throws ParseException, IOException {
        Long longOrgOwner = getLongAttributeValue(node, "OrgOwner");
        if(longOrgOwner != null) setOrgOwner(longOrgOwner);
        Date dateOfGoodsCreationDate = getDateAttributeValue(node,"Date");
