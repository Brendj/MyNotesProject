 ...
 * Date: 11.03.12
 * Time: 13:46
 * Отчет по продажам, не имеет шаблона
 */
public class MscSalesReport extends BasicReportForOrgJob {
    ...
    */
    public static final String REPORT_NAME = "Отчет по продажам";
    ...
    public static class Builder extends BasicReportJob.Builder {
        ...
        private JRDataSource createDataSource(Session session, OrgShortItem org, Date startTime, Date endTime,
            ...
            */
            ...
            freeComplexQuery1.setParameter("typeComplex1", OrderDetail.TYPE_COMPLEX_MIN);
            freeComplexQuery1.setParameter("typeComplex10", OrderDetail.TYPE_COMPLEX_MAX);
