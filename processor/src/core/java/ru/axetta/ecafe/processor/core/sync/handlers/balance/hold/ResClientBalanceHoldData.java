...
public class ResClientBalanceHoldData implements AbstractToElement {
    private List<ClientBalanceHoldItem> items;

    public ResClientBalanceHoldData() {
    ...
    public Element toElement(Document document) throws Exception {
        Element element = document.createElement("ResClientBalanceHold");
