...
public class DetailedDeviationsPaymentOrReducedPriceMealsIntervalJasperReport extends BasicReportForAllOrgJob {
   ...
   */
    ...
    public static final String[] TEMPLATE_FILE_NAMES = {"DetailedDeviationsPaymentOrReducedPriceMealsIntervalJasperReport.jasper",
                                                        "DetailedDeviationsPaymentOrReducedPriceMealsInterval_Subreport.jasper"};
