...
public class JournalBalancesReport extends BasicReportForAllOrgJob {
   ...
   */
    public static final String REPORT_NAME = "Журнал регистрации операций изменения балансов лицевых счетов";
    public static final String[] TEMPLATE_FILE_NAMES = {"JournalBalancesReport.jasper"};
