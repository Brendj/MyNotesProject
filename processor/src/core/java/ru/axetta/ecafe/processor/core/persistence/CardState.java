...
public enum CardState {
    UNKNOWN(-1,"Неизвестная карта."),//Карта еще не присутствует в системе
    ...
    BLOCKED(6,"Заблокирована."),//Карта запрещена к обслуживанию, запрещены все операции кроме 7 и 8.
