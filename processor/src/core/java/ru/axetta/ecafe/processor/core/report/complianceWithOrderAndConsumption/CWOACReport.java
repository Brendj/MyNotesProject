...
public class CWOACReport extends BasicReportForAllOrgJob {
    ...
    */
    public static final String REPORT_NAME = "Отчет по соответствию заказа и потребления резервной группе";
    public static final String[] TEMPLATE_FILE_NAMES = {"CWOACReport.jasper"};
