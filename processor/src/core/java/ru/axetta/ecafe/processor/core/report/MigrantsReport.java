...
public class MigrantsReport extends BasicReportForListOrgsJob {
    ...
    */
    public static final String REPORT_NAME = "Отчет по временным клиентам других организаций";
    public static final String[] TEMPLATE_FILE_NAMES = {"MigrantsReport.jasper"};
