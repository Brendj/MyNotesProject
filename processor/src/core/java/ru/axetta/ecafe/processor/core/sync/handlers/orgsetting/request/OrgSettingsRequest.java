            ...
            if (nodeElement.getNodeName().equals("OS")) {
                ...
                while (nodeItem != null) {
                    if (nodeItem.getNodeName().equals("OSI")) {
                        ...
                        if (item.getType().equals(OrgSettingsDataTypes.BOOLEAN.ordinal())) {
                            boolean val = XMLUtils.getStringAttributeValue(nodeItem, "SValue", 512).equals("1");
                            item.setValue(Boolean.toString(val));
                        } else {
