...
public class QuestionaryResultByOrgReport extends BasicReportForOrgJob {
    ...
    */
    public static final String REPORT_NAME = "Отчет по анкетированию за период";
    public static final String[] TEMPLATE_FILE_NAMES = {"QuestionaryResultByOrgReport.jasper"};
