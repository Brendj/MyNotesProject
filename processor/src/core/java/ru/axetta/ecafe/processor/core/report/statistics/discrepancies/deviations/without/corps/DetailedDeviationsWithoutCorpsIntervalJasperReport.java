...
public class DetailedDeviationsWithoutCorpsIntervalJasperReport extends BasicReportForAllOrgJob {
    ...
    */
    ...
    public static final String[] TEMPLATE_FILE_NAMES = {"DetailedDeviationsWithoutCorpsIntervalJasperReport.jasper",
                                                        "DetailedDeviationsWithoutCorpsIntervalJasperReport_Subreport.jasper"};
