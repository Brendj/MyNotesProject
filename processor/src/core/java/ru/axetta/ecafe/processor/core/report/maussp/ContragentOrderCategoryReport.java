...
public class ContragentOrderCategoryReport extends BasicJasperReport {
    ...
    */
    public static final String REPORT_NAME = "Отчет по реализации за месяц";
    public static final String[] TEMPLATE_FILE_NAMES = {"ContragentOrderCategoryReport.jasper"};
