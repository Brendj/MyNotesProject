        ...
        private JRDataSource createDataSource(Session session, OrgShortItem org, Date startTime, Date endTime,
            ...
            Query menuOriginQuery = session
                    .createSQLQuery(String.format("SELECT DISTINCT od.%s FROM CF_ORDERS o,CF_ORDERDETAILS od " +
                            " WHERE (o.idOfOrg in (:idOfOrg) AND od.idOfOrg=:idOfOrg) AND (o.IdOfOrder=od.IdOfOrder) AND (od.MenuType=:typeDish) and o.state=0 and od.state=0 AND "
                            +
            ...
            {
                menuOriginQuery.setParameter("idOfOrg", orgShortItemList.get(0).getIdOfOrg());
            }
            //Если по всем корпусам
                ...
                menuOriginQuery.setParameter("idOfOrg", idOrgs);
            }
