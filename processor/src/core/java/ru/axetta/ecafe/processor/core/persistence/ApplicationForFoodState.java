...
public enum ApplicationForFoodState {
    ...
    INFORMATION_RESPONSE_PASSPORT("7705.1", "Сведения о действительности паспорта заявителя получены", "Сведения о действительности паспорта заявителя получены."),
    INFORMATION_RESPONSE_GUARDIAN("7705.2", "Сведения о действительности паспорта заявителя получены", "Сведения о действительности паспорта заявителя получены."),
