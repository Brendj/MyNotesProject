...
public enum ApplicationForFoodState {
    FILED("1010", "Заявление подано", ""),
    TRY_TO_REGISTER("1040", "Заявление доставлено в ведомство", "Подано. Заявление передано в ОИВ и находится на рассмотрении."),
    ...
    DENIED_BENEFIT("1080.1", "Отказ в предоставлении услуги", "Основание для отказа: По результатам межведомственной проверки льготный статус ребенка не подтвержден"),
    DENIED_GUARDIANSHIP("1080.2", "Отказ в предоставлении услуги", "Основание для отказа: По результатам межведомственной проверки не подтверждено родство."),
