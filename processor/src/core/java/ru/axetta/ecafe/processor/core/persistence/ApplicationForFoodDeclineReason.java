...
public enum ApplicationForFoodDeclineReason {
    ...
    INFORMATION_CONFLICT(3, "Основание для отказа: «По результатам межведомственного взаимодействия с Департаментом труда и социальной защиты населения города "
