...
public enum ApplicationForFoodDeclineReason {
    NO_DOCS(1, "Основание для отказа: «Заявитель не представил документы, подтверждающие право на льготное питание»."),
    NO_APPROVAL(2, "Основание для отказа: «Право на получение питания за счет бюджета города Москвы не подтверждено по результатам решения Управляющего совета школы»."),
    INFORMATION_CONFLICT(3, "Основание для отказа: «Льготный статус ребенка не подтвержден по результатам межведомственного взаимодействия "
            + "с Департаментом труда и социальной защиты населения города Москвы»");
