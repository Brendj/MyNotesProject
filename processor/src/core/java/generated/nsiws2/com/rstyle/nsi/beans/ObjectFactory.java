 ...
 * generated in the generated.nsiws2.com.rstyle.nsi.beans package.
...
public class ObjectFactory {
    ...
    private final static QName _GetInformationFromEgrulRequest_QNAME = new QName("http://rstyle.com/nsi/beans", "getInformationFromEgrulRequest");
    ...
    private final static QName _StudentSearch_QNAME = new QName("http://rstyle.com/nsi/beans", "studentSearch");
    ...
    private final static QName _Items_QNAME = new QName("http://rstyle.com/nsi/beans", "items");
    private final static QName _GetSpecResponse_QNAME = new QName("http://rstyle.com/nsi/beans", "getSpecResponse");
    private final static QName _CheckRequest_QNAME = new QName("http://rstyle.com/nsi/beans", "checkRequest");
    private final static QName _CategoryNames_QNAME = new QName("http://rstyle.com/nsi/beans", "categoryNames");

    /**
     * Create a new ObjectFactory that can be used to create new instances of schema derived classes for package: generated.nsiws2.com.rstyle.nsi.beans
     * 
     */
    ...
    /**
     * Create an instance of {@link GetInformationFromEgrulRequest }
     * 
     */
    public GetInformationFromEgrulRequest createGetInformationFromEgrulRequest() {
        return new GetInformationFromEgrulRequest();
    }
    ...
    /**
     * Create an instance of {@link StudentSearch }
     * 
     */
    public StudentSearch createStudentSearch() {
    ...
    /**
     * Create an instance of {@link RsItem }
     * 
     */
    public RsItem createRsItem() {
        return new RsItem();
    }
    ...
    /**
     * Create an instance of {@link RsEntry }
     * 
     */
    public RsEntry createRsEntry() {
        return new RsEntry();
    }
    ...
    /**
     * Create an instance of {@link RsCategory }
     * 
     */
    public RsCategory createRsCategory() {
    ...
    /**
     * Create an instance of {@link JAXBElement }{@code <}{@link GetInformationFromEgrulRequest }{@code >}}
     * 
     */
    @XmlElementDecl(namespace = "http://rstyle.com/nsi/beans", name = "getInformationFromEgrulRequest")
    public JAXBElement<GetInformationFromEgrulRequest> createGetInformationFromEgrulRequest(GetInformationFromEgrulRequest value) {
        return new JAXBElement<GetInformationFromEgrulRequest>(_GetInformationFromEgrulRequest_QNAME, GetInformationFromEgrulRequest.class, null, value);
    }
    ...
    /**
     * Create an instance of {@link JAXBElement }{@code <}{@link StudentSearch }{@code >}}
     * 
     */
    @XmlElementDecl(namespace = "http://rstyle.com/nsi/beans", name = "studentSearch")
    public JAXBElement<StudentSearch> createStudentSearch(StudentSearch value) {
        return new JAXBElement<StudentSearch>(_StudentSearch_QNAME, StudentSearch.class, null, value);
    }
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://rstyle.com/nsi/beans", name = "items")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://rstyle.com/nsi/beans", name = "checkRequest")
    public JAXBElement<String> createCheckRequest(String value) {
        return new JAXBElement<String>(_CheckRequest_QNAME, String.class, null, value);
    }
