 ...
 * 					b) Текущий клиент не является зарегистрированным поставщиком сведений по запрошенному типу
 * 					сообщения.
 * 				
 * 
 ...
 * 
 */
@WebFault(name = "UnknownMessageType", targetNamespace = "urn://x-artefacts-smev-gov-ru/services/message-exchange/types/faults/1.2")
