 ...
 * 
 */
@WebServiceClient(name = "SubscriptionService", targetNamespace = "urn://emp.altarix.ru/subscriptions", wsdlLocation = "http://api.uat.emp.mos.ru:8090/ws/subscriptions/?wsdl")
    ...
    extends Service
{
    ...
    private final static QName SUBSCRIPTIONSERVICE_QNAME = new QName("urn://emp.altarix.ru/subscriptions", "SubscriptionService");

    static {
        URL url = null;
        WebServiceException e = null;
        try {
            url = new URL("http://api.uat.emp.mos.ru:8090/ws/subscriptions/?wsdl");
    ...
    public SubscriptionPortType getServicePort() {
        return super.getPort(new QName("urn://emp.altarix.ru/subscriptions", "ServicePort"), SubscriptionPortType.class);
    }
    ...
    public SubscriptionPortType getServicePort(WebServiceFeature... features) {
        return super.getPort(new QName("urn://emp.altarix.ru/subscriptions", "ServicePort"), SubscriptionPortType.class, features);
    }
