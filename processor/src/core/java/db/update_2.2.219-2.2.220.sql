...
CREATE UNIQUE INDEX cf_hardware_settings_unique_index_id ON cf_hardware_settings USING btree (idofhardwaresetting, idoforg);

CREATE TABLE public.cf_hardware_settings_mt
(
  idofhardwaresetting int8 NOT NULL,
...
CREATE TABLE public.cf_turnstile_settings
(
