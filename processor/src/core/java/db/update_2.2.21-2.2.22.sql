...
CREATE TABLE  cf_return_documents (
  IdOfReturnDocument BigSerial NOT NULL,
  GUID character varying(36) NOT NULL,
  GlobalVersion BIGINT DEFAULT NULL,
  OrgOwner bigint,
  DeletedState boolean NOT NULL DEFAULT false,
  ...
  LastUpDate bigint,
  DeleteDate bigint,
  CONSTRAINT cf_return_documents_pk PRIMARY KEY (IdOfReturnDocument )
);
...
CREATE TABLE  cf_internal_incoming_documents (
  ...
  IdOfInternalDisposingDocument bigint NOT NULL,
  IdOfActOfInventarization bigint NOT NULL,
  IdOfReturnDocument bigint NOT NULL,
  IdOfStaff bigint NOT NULL,
  GUID character varying(36) NOT NULL,
  GlobalVersion BIGINT DEFAULT NULL,
  OrgOwner bigint,
  ...
  CONSTRAINT cf_internal_incoming_documents_act_of_inventarization_fk FOREIGN KEY (IdOfActOfInventarization)
      REFERENCES cf_acts_of_inventarization (IdOfActOfInventarization),
  CONSTRAINT cf_internal_incoming_documents_return_document_fk FOREIGN KEY (IdOfReturnDocument)
      REFERENCES cf_return_documents (IdOfReturnDocument),
