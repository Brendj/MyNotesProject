...
ALTER TABLE cf_orgregistrychange ALTER COLUMN short_address TYPE character varying(512),
  ALTER COLUMN short_addressfrom TYPE character varying(512);

ALTER TABLE cf_orgregistrychange_item ALTER COLUMN short_address TYPE character varying(512),
  ALTER COLUMN short_addressfrom TYPE character varying(512);
