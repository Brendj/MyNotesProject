...
<h:panelGrid id="settlementCreatePanel" binding="#{mainPage.settlementCreatePage.pageComponent}"
    ...
    <rich:calendar value="#{mainPage.settlementCreatePage.paymentDate}" datePattern="dd.MM.yyyy" converter="dateConverter"
...
<h:panelGrid styleClass="borderless-grid">
    <a4j:commandButton value="Зарегистрировать платеж" action="#{mainPage.createSettlement}"
                       reRender="settlementCreatePanel" styleClass="command-button" />
</h:panelGrid>
<h:panelGrid styleClass="borderless-grid">
