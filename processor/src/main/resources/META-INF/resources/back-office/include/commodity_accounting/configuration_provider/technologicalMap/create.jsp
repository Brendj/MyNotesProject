...
<%--@elvariable id="technologicalMapCreatePage" type="ru.axetta.ecafe.processor.web.ui.commodity.accounting.configurationProvider.technologicalMap.TechnologicalMapCreatePage"--%>
<h:panelGrid id="technologicalMapCreatePanel" binding="#{technologicalMapCreatePage.pageComponent}"
    ...
    <rich:dataTable id="productsTableCreate" value="#{technologicalMapCreatePage.technologicalMapProducts}" var="technologicalMapProduct" >
        ...
        <rich:column style="text-align:center">
            <a4j:commandLink ajaxSingle="true" styleClass="command-link" action="#{technologicalMapCreatePage.deleteProduct}" reRender="productsTableCreate">
