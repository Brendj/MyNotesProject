...
<%
    response.setHeader("Content-disposition", "inline;filename=Reconciliation_Missing.csv");
%>
<f:view>
    <h:outputText escape="false" value=";Время;Сумма;Лицевой счет;Ид. платежа"/>
    ...
    <a4j:repeat value="#{reconciliationPage.differencesList}" var="item" rowKeyVar="row">
        <h:outputText escape="false" value="#{item.registryItem.toCsvString()}#{mainPage.endOfLine}"
