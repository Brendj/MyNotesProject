...
/usr/local/jre/bin/java -Xms32M -Xmx32M -Xmn12M -Xss1m -Dij.protocol=jdbc:derby: org.apache.derby.tools.ij < /home/jbosser/updates/update_0.1.1-0.1.2/ecafe_processor_derby_gymn19_IdOfSms_0.1.2.sql
