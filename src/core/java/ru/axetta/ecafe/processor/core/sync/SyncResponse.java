...
public class SyncResponse {
    ...
    public static class ResCategoriesDiscountsAndRules {
        public static class DCI {
            ...
            public DCI(long idOfCategoryDiscount, String categoryName) {
        ...
        public static class DCRI {
            ...
            public DCRI(long idOfRule, long idOfCategoryDiscount, String description, int complex0, int complex1,
            ...
            @Override
            public String toString() {
                return "DCRI{" + "idOfRule=" + idOfRule + ", idOfCategoryDiscount=" + idOfCategoryDiscount
