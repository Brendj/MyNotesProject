...
public class PayComplexReport extends BasicReport {
    ...
    public static class Builder {
        ...
        public PayComplexReport build(Session session, Date startDate, Date endDate, List<Long> idOfOrgList)
                throws Exception {
            ...
            if (!idOfOrgList.isEmpty()) {
                ...
                String preparedQuery = "select org.officialName, od.menuDetailName, od.rPrice, od.discount, "
                        ...
                        + orgCondition
                        + "   and (((od.rPrice + od.discount) <> od.discount and o.trdDiscount is null) "
                        + "    or (o.trdDiscount is not null "
                        + "   and ((od.discount <> o.socDiscount and o.socDiscount > 0) or o.socDiscount = 0)))"
    ...
    public PayComplexReport() {
        super();
        this.complexItems = Collections.emptyList();
    }

    public PayComplexReport(Date generateTime, long generateDuration, List<ComplexItem> complexItems) {
