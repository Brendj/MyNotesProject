...
%><f:view>
    ...
    <a4j:repeat value="#{mainPage.enterEventReportPage.enterEventReport.enterEventItems}" var="item">
        <h:outputText escape="false" value="#{item.idofenterevent}" converter="contractIdConverter" />
        <h:outputText escape="false" value=";#{item.idoforg};#{item.officialname};#{item.entername};#{item.turnstileaddr};#{item.passdirection};#{item.eventCode};#{item.docserialnum};#{item.personFullName};" />
