 ...
 */
public class CardPrintedNoConverter implements Converter {

    private static final Logger logger = LoggerFactory.getLogger(CardPrintedNoConverter.class);
    ...
    public String getAsString(FacesContext facesContext, UIComponent uiComponent, Object object) {
        ...
        return CardPrintedNoFormat.format(value);
    }
}