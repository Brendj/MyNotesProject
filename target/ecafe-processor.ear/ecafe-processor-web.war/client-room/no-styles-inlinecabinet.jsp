...
<%
    ...
    String[] pageNames = {
            SHOW_ORDERS_AND_PAYMENTS_PAGE, SHOW_MENU_PAGE, null, SHOW_CARDS_PAGE, PAY_BANK_INFO, PREPARE_PAY_PAGE,
            CHANGE_PERSONAL_INFO_PAGE, CHANGE_PASSWORD_PAGE, LOGOUT_PAGE};
    String[] labels = {
            "Покупки и платежи", "Узнать меню", "Дневник", "Мои карты", "Оплата в банке", "Оплата он-лайн",
