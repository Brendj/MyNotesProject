...
<h:panelGrid id="freeComplexReportPanelGrid" binding="#{mainPage.freeComplexReportPage.pageComponent}" styleClass="borderless-grid">
    <h:panelGrid styleClass="borderless-grid" columns="2">
        ...
        <h:panelGroup>
            <a4j:commandButton value="..." action="#{mainPage.showOrgListSelectPage}" reRender="modalOrgListSelectorPanel"
                ...
                <f:setPropertyActionListener value="#{mainPage.freeComplexReportPage.getStringIdOfOrgList}" target="#{mainPage.orgFilterOfSelectOrgListSelectPage}"/>
            </a4j:commandButton>
        ...
        <a4j:commandButton value="Генерировать отчет" action="#{mainPage.buildFreeComplexReport}"
                           reRender="mainMenu, workspaceTogglePanel, freeComplexReportTable"
    ...
    <h:panelGrid styleClass="borderless-grid">
        ...
        <rich:dataTable id="freeComplexReportTable" value="#{mainPage.freeComplexReportPage.complexReport.complexItems}"
            ...
            <f:facet name="footer">
                <rich:datascroller for="freeComplexReportTable" renderIfSinglePage="false" maxPages="10" fastControls="hide"
        ...
        <h:commandButton value="Выгрузить в CSV" action="#{mainPage.showFreeComplexCSVList}" styleClass="command-button" />
    </h:panelGrid>
