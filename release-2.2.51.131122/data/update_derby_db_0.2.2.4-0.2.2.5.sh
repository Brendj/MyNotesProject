...
/usr/local/jre/bin/java -Xms32M -Xmx32M -Xmn12M -Xss1m -Dij.protocol=jdbc:derby: org.apache.derby.tools.ij < /home/jbosser/updates/update_0.2.2.4-0.2.2.5/ecafe_processor_derby_0.2.2.5.sql
